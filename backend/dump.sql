...
COPY public.companies (company_id, rut, name, email) FROM stdin;
1	208692461	Empresa callampin	sdfkjskdfs@gmail.com
\.
...
9	64000	2025-02-10 20:36:12.1154	10
12	123556	2025-02-14 01:31:50.31959	14
14	234021	2025-02-14 01:38:21.062855	14
15	24543	2025-02-14 21:57:50.001586	10
\.
...
1	208692461	Matias	Bravo	Mendoza	matias.bravo2102@alumnos.ubiobio.cl	+56936005441	administrador
4	208692463	Matias	Bravo	Mendoza	matias.bravo2102@alumnos.ubioio.cl	+56936005442	cliente
\.
...
1	Mobile Delvac Super 1300	30.00	5990	8790	Aceite de motor para camiones	5	3	4
2	Mobil 1 Esp 5w30	30.00	5990	56990	Aceite de motor para camiones	10	3	4
5	Aceite de Motor CASTROL CRB Mineral 15W40 946ml	30.00	9000	6000	El aceite de motor CASTROL CRB Mineral 15W40 está formulado específicamente para motores diésel en vehículos comerciales y maquinaria. La tecnología Castrol RX Boost (CRB) proporciona una protección avanzada contra el desgaste y la formación de depósitos. Este aceite ayuda a mantener el motor limpio y eficiente, mejorando su rendimiento bajo condiciones exigentes y extendiendo su vida útil. Ideal para quienes buscan confiabilidad y durabilidad en sus motores diésel.	15	3	4
\.
...
12	Cambio de aceite	pending	40580.00	2025-02-12 00:35:38.680416	10
14	Aaaaaaaaaaaa	pending	116446.00	2025-02-14 21:46:39.971776	14
\.
...
COPY public.stock_products (stock_product_id, updated_at, product_id, quantity) FROM stdin;
1	2025-02-10 19:21:58.357441	1	5
2	2025-02-12 01:41:34.795893	2	10
5	2025-02-14 21:31:45.416547	5	15
\.
...
3	Supplier Name	123 Supplier Address	Supplier City	Description of the supplier	56912345678
\.
...
1	administrador	admin	$2a$10$P3tHPLxxBVnY6Rwybh4MeeiUC0AEB6m8wmsWxENvOxgYjhKntPFvG	1
\.
...
14	SDF1312	running	2025	NEGRO	1	1	\N
10	QAKE233	running	2023	Negro	1	\N	1
\.
...
COPY public.work_orders (work_order_id, total_amount, order_status, order_date, vehicle_id, quotation_id) FROM stdin;
\.
...
2	2	17580.00	0.00	23000.00	\N	1	12	1
5	1	6000.00	0.00	23456.00	\N	5	14	1
6	1	56990.00	0.00	30000.00	\N	2	14	1
\.
...
SELECT pg_catalog.setval('public.mileage_history_mileage_history_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.product_categories_product_category_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.quotations_quotation_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.stock_products_stock_product_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.taxes_tax_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.vehicle_brands_vehicle_brand_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.vehicle_models_vehicle_model_id_seq', 12, true);
...
SELECT pg_catalog.setval('public.vehicles_vehicle_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.work_product_details_work_product_detail_id_seq', 6, true);
...
--
-- Name: stock_products UQ_378d8fa4ec52d825ecdccd2f555; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.stock_products
    ADD CONSTRAINT "UQ_378d8fa4ec52d825ecdccd2f555" UNIQUE (product_id);
